...
python opennmt/bin/build_vocab.py --min_frequency 5 --save_vocab data/recom_nlg/clothes/one_per_sku/words-outs-$d.vocab  $1/recom_text.words.$d.filter.seg $1/recom_text.outs.$d.seg.temp
