...
def batch_parallel_dataset(batch_size,
  ...
  if batch_type == "examples":
    return group_by_window_fn(_key_func, _reduce_func, window_size=batch_size)
  elif batch_type == "tokens":
    return group_by_window_fn(_key_func, _reduce_func, window_size_func=_window_size_func)
  else:
    raise ValueError(
