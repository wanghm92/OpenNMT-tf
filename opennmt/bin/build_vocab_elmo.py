...
def main():
  ...
  special_tokens = [constants.UNKNOWN_TOKEN.upper()]
  if not args.without_sequence_tokens:
    special_tokens.append(constants.START_OF_SENTENCE_TOKEN.upper())
    special_tokens.append(constants.END_OF_SENTENCE_TOKEN.upper())
