...
class AttentionWrapper(rnn_cell_impl.RNNCell):
  ...
  def __init__(self,
    ...
    **NOTE** If you are using the `BeamSearchDecoder` with a cell wrapped in
    ...
    tf.logging.info(" >> [tf_attention_wrapper.py AttentionWrapper] attention_layer_size = {}".format(attention_layer_size))
  ...
  def call(self, inputs, state):
    ...
    tf.logging.info(" >> [tf_attention_wrapper.py AttentionWrapper call()] inputs = {}".format(inputs))
    tf.logging.info(" >> [tf_attention_wrapper.py AttentionWrapper call()] state = {}".format(state))

    cell_inputs = self._cell_input_fn(inputs, state.attention)
    cell_state = state.cell_state

    tf.logging.info(" >> [tf_attention_wrapper.py AttentionWrapper call()] cell_inputs = {}".format(cell_inputs))
    tf.logging.info(" >> [tf_attention_wrapper.py AttentionWrapper call()] cell_state = {}".format(cell_state))
